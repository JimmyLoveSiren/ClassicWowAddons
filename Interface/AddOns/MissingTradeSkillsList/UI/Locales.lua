...
MTSLUI_LOCALES_LABELS = {
    ...
    ["mtsl frame location"] = {
        ["English"] = "MTSL frame location",
        ["French"] = "Emplacement de trame MTSL",
        ["German"] = "MTSL-Frame-Position",
        ["Russian"] = "Расположение кадра MTSL",
        ["Korean"] = "MTSL 프레임 위치",
        ["Chinese"] = "MTSL框架位置",
        ["Spanish"] = "Ubicación del marco MTSL",
        ["Mexican"] = "Ubicación del marco MTSL",
        ["Portuguese"] = "Localização do quadro MTSL",
        ["Taiwanese"] = "MTSL框架位置",
    },
    ["missing skills"] = {
