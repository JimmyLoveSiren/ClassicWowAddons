...
MTSLOPTUI_CONFIG_FRAME = {
    ...
    MARGIN_RIGHT = 285,
    WIDTH_DD = 100,
    ui_split_keys = { "MTSL", "ACCOUNT", "DATABASE", "NPC" },
    ui_scale_keys = { "MTSL", "ACCOUNT", "DATABASE", "NPC", "OPTIONSMENU" },
    ...
    InitialiseOptionsMTSLFrameLocation = function (self, margin_top)
        ...
        self.ui_frame.location_mtsl_drop_down = MTSLUI_TOOLS:CreateDropDown("MTSLOPTUI_CONFIG_FRAME_DD_location_MTSL", self.ui_frame, self.ui_frame, "TOPLEFT", self.MARGIN_RIGHT, margin_top + 7, self.CreateDropDownLocationMTSL, self.WIDTH_DD)
    end,
    ...
    InitialiseOptionsUISplitOrientation = function (self, margin_top)
        ...
        self.ui_frame.ui_split_MTSL_drop_down = MTSLUI_TOOLS:CreateDropDown("MTSLOPTUI_CONFIG_FRAME_DD_ui_split_MTSL", self.ui_frame, self.ui_frame.location_mtsl_drop_down, "BOTTOMLEFT", 0, -18, self.CreateDropDownOrientationMTSL, self.WIDTH_DD)
        ...
        self.ui_frame.ui_split_DATABASE_drop_down = MTSLUI_TOOLS:CreateDropDown("MTSLOPTUI_CONFIG_FRAME_DD_ui_split_DB", self.ui_frame, self.ui_frame.ui_split_ACCOUNT_drop_down, "TOPRIGHT", -20, 0, self.CreateDropDownOrientationDatabase, self.WIDTH_DD)
    ...
    InitialiseOptionsUISplitScale = function (self, margin_top)
        ...
        self.ui_frame.ui_scale_DATABASE_drop_down = MTSLUI_TOOLS:CreateDropDown("MTSLOPTUI_CONFIG_FRAME_DD_SCALE_DB", self.ui_frame, self.ui_frame.ui_scale_ACCOUNT_drop_down, "TOPRIGHT", -20, 0, self.CreateDropDownScaleDatabase, self.WIDTH_DD)
    ...
    CreateDropDownLocationMTSL = function(self, level)
        MTSLUI_TOOLS:FillDropDown(MTSLOPTUI_CONFIG_FRAME.drop_down_lists.mtsl_frame_locations, MTSLOPTUI_CONFIG_FRAME.ChangeLocationMTSLHandler)
    end,
    ...
    ChangeLocationMTSLHandler = function(value, text)
        MTSLOPTUI_CONFIG_FRAME:ChangeValue("location_mtsl", value, text)
    end,
    ...
    Save = function(self)
        ...
        MTSLUI_SAVED_VARIABLES:SetMTSLLocation(self.config_values.location_mtsl)
    ...
    ResetUI = function (self)
        ...
        UIDropDownMenu_SetText(self.ui_frame.location_mtsl_drop_down, MTSLUI_TOOLS:GetLocalisedLabel(string.lower(self.config_values.location_mtsl)))
        -- Split modes
        for _, k in pairs(self.ui_split_keys) do
    ...
    LoadSavedVariables = function(self)
        ...
        self.config_values.location_mtsl = MTSLUI_SAVED_VARIABLES:GetMTSLLocation()
