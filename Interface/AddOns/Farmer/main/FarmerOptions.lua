...
local function initPanel ()
  ...
  anchor = createCheckButton('reputation', anchor, 0, -15, L['show reputation'])
  createSlider('reputationThreshold', anchor, 140, 0, L['minimum'], 1, 100, '1', '100', 'LEFT', 'RIGHT')
...
addon:on('PLAYER_LOGIN', function (name)
  ...
  checkOption('skills', true)
  checkOption('reputation', true)
  checkOption('reputationThreshold', 15)
